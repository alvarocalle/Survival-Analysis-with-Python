...
-- as of July 31st.  Limit the table to drives 1.5TB or bigger,
-- to exclude boot drives.  If you wish to see drives of all sizes
-- remove the line 'AND 1500000000000 <= capacity_bytes'
--
...
-- are included.  To include drives with less than 45 drives
-- remove the line 'AND 45 <= model_count.count'
--
